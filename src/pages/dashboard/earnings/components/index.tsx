...
const ViewSettingsPage = () => {
  ...
  return (
    <div className="lg:w-[750px]  mx-auto px-6">
      ...
      <Card className={`${DEFAULT_CARD_RESTYLE} flex items-center justify-between py-8 `}>
        <div>
        <h3 className='text-muted-gray100 text-sm font-semibold'>OUTSTANDING BALANCE</h3>
